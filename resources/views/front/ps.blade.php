...
@section('title') Kamp & Dağcılık @endsection
@section('content')

<div class="page-head_agile_info_w3l">
    <div class="container">
        <h3>Kamp & Dağcılık<span></span></h3>
        <!--/w3_short-->
               ...
               <!--   <h5>Ürün <span>Karşılaştırma(0)</span></h5>
                ...
                <div class="men-wear-bottom">
                    ...
                    <div class="col-sm-8 men-wear-right">
                        <h4>Kamp & <span>Dağcılık</span></h4>
                        <p style="text-align: justify">aktiviteler, doğanın güzelliklerini keşfetmek, sıradan yaşamdan kaçmak ve kendilerini doğanın ortasında bulma fırsatı sunar. Kamp ve dağcılık kategorimiz, bu tutkulu doğa severlere yönelik en iyi outdoor ekipmanları sunmak için tasarlanmıştır. </p>
                    </div>
                    <div class="clearfix"></div>
                </div>
