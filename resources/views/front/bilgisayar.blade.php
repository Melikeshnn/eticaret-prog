...
@section('title') Giyim & Ayakkabı @endsection
@section('content')

    <div class="page-head_agile_info_w3l">
        <div class="container">
            <h3>Giyim & Ayakkabı<span></span></h3>
            <!--/w3_short-->
            ...
            <!-- <h5>Ürün <span>Karşılaştırma(0)</span></h5>
                ...
                <div class="men-wear-bottom">
                    ...
                    <div class="col-sm-8 men-wear-right">
                        <h4>Giyim &  <span>Ayakkabı</span></h4>
                        <p style="text-align: justify">Outdoor aktiviteler için uygun giyim ve ayakkabılar, açık hava koşullarına dayanıklı ve rahat olmalıdır. Bu ürünler, dağcılık, trekking, kampçılık, bisiklet sürme, yürüyüş ve diğer outdoor aktiviteleri yaparken koruma, performans ve konfor sağlar. </p>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="clearfix"></div>
